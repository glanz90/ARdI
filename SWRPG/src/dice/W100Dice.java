...
public class W100Dice extends Dice {
	...
	public W100Dice(Dice_Symbol dice_symbol, LinkedList<IconSymbol> face_symbols) {
		super(100, DiceType.W100Dice, dice_symbol, face_symbols);
	}

	public W100Dice(Dice_Symbol dice_symbol, LinkedList<IconSymbol> face_symbols, byte[] seed) {
	...
	public W100Dice(DiceType type, Dice_Symbol dice_symbol, LinkedList<IconSymbol> face_symbols) {
		super(100, type, dice_symbol, face_symbols);
	}

	public W100Dice(DiceType type, Dice_Symbol dice_symbol, LinkedList<IconSymbol> face_symbols, byte[] seed) {
